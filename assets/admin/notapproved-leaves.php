...
<?php 
$cnt = 1;
$sql = mysqli_query($con, "select * from tblleaves where  Status = 3");
...
if($result['Status']==3){
           ...
           <td><a href="leave_details.php?EmpID=<?php echo $result['EmpID'];?>" title="Approval"><i class="fa fa-desktop"></i></a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
